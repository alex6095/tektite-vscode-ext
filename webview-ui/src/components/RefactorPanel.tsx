...
export const RefactorPanel: React.FC<RefactorPanelProps> = ({
    ...
    const handleAnalyze = async () => {
        ...
        try {
            const prompt = `You are an expert Python code refactorer.
            ...
            const schema = {
                ...
                properties: {
                    ...
                    complexityOriginal: { type: "INTEGER" },
                    complexityRefactored: { type: "INTEGER" },
                    diffOriginalSnippet: { type: "STRING" },
                    diffNewSnippet: { type: "STRING" },
                    fullRefactoredCode: { type: "STRING" },
                }
            };

            const response = await vscodeApi.callAI(prompt, schema);
                    ...
                    <div className="h-full flex flex-col">
                        <div className="flex items-center justify-between text-xs text-gray-400 mb-2">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                {isPythonReady && <span className="text-green-400">Terminal Ready</span>}
                            </div>
                        </div>
                        <div
                            ref={scrollRef}
